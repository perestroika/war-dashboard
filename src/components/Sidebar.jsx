    ...
    return (
        <div className="w-72 min-h-screen border-r border-opacity-15 px-8 h-screen sticky top-0">
            ...
            <div className="side-menu font-medium leading-5 space-y-1.5">
                {/* active link */}
                <a href="http://localhost:3000/"   className="flex hover:bg-brand-primary hover:text-white hover:rounded-2xl hover:shadow-primary p-5">
                    <span className="inline-flex "><i className="fas fa-project-diagram text-lg mr-4"/> Continents</span>
                </a>
                <a href="http://localhost:3000/country" className="flex hover:bg-brand-primary hover:text-white hover:rounded-2xl hover:shadow-primary p-5">
